...
/**
 * Class for testing adjacency matrix implementation of graph interface.
 * @author Kathleen
 *
 */
public class AdjMatrixGraphTest {
    ...
    /**
     * Method to test graphContains.
     */
    @Test
    public void testGraphContains(){
        graph.addVertex(v1);
        assertTrue(graph.graphContains(v1));
        assertFalse(graph.graphContains(v2));
    }
}
