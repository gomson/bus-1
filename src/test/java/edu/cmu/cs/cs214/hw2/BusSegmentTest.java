...
public class BusSegmentTest {
   ...
   private static final int END_TIME = 6;
    ...
    public void setUp(){
        ...
        t1 = new BusSegment(start, end, "61C", START_TIME, END_TIME);
    }
    ...
    public void testgetSegmentType(){
        assertEquals(t1.getSegmentType(), "Bus");
    }
    ...
    public void testGetSegmentInstructions(){
        String str = "Take the 61C from "
                + t1.getSegmentStartLoc().getName() + " to "
                + t1.getSegmentEndLoc().getName() + " which will take "
